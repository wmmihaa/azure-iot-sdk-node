...
describe('ProvisioningServiceClient', function() {
  ...
  function testDeleteAPI(methodUnderTest, uriPath, falsyArgArgumentName, firstArgumentObject, firstArgumentObjectNoEtag, firstArgumentObjectIdPropertyName) {
    ...
    describe('#' + methodUnderTest, function() {
      ...
      /*Tests_SRS_NODE_PROVISIONING_SERVICE_CLIENT_06_025: [The `deleteDeviceRegistrationState` method shall throw `ReferenceError` if the `idOrRegistrationStatus` argument is falsy.] */
  ...
  testDeleteAPI('deleteDeviceRegistrationState', '/registrations/', 'registrationStatus', fakeRegistration, fakeRegistrationNoEtag, 'registrationId');
