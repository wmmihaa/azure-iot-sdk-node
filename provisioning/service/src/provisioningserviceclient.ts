...
export class ProvisioningServiceClient {
   ...
   * @param {function} callback Invoked upon completion of the operation.
   */
  public getDeviceRegistrationState(id: string, callback: (err: Error, registrationStatus?: DeviceRegistrationState, response?: any) => void): void {
   ...
   * @param {object | string}   idOrRegistration A string containing the registration id OR an actual DeviceRegistrationState.
   * @param {string | function} etagOrCallback   In the case of the first argument being a string this could be an etag (or the callback).
   * @param {function}          deleteCallback   Invoked upon completion of the operation.
   */
  public deleteDeviceRegistrationState(idOrRegistrationStatus: string | DeviceRegistrationState, etagOrCallback?: string | DeleteCallback, deleteCallback?: DeleteCallback): void {
  ...
  private _delete(endpointPrefix: string, enrollmentOrIdOrRegistration: string | any, etagOrCallback?: string | DeleteCallback, deleteCallback?: DeleteCallback): void {
    ...
    /*Codes_SRS_NODE_PROVISIONING_SERVICE_CLIENT_06_025: [The `deleteDeviceRegistrationState` method shall throw `ReferenceError` if the `idOrRegistrationStatus` argument is falsy.] */
